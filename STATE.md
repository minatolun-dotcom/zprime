...
**Last updated:** 2026-09-23 — **R-46 IRP/EWB readiness drill CLOSED as evidence (no release — verdict: no defect; connectivity production-ready pending real credentials).** Live drill 39/39 against the mock IRP on the running v1.44.0 stack: fail-fast posture, credential lifecycle + masking, e-invoice accept/duplicate/reject+retry, full EWB lifecycle on both birth paths (eivital + ewayapi), B2C direct EWB, authorization layering; runbook verified consistent; zero P1/P2/P3, three P4s recorded. Evidence: `R-46_INVESTIGATION.md`. Previous: **v1.44.0 (R-45 whole-product re-review) RELEASED — v1.43.0 re-certified on fresh evidence.** Release commit `dec00ad98716ee138792592498b44af3fe50da24`, annotated tag `1e21881f489b6922a565a37bb08eb574dc89c9a1` → commit verified via for-each-ref; pushed. Full battery on rebuilt image + fresh volume: browser **517/517** (run.js 153/153 + all 26 scenario suites), Python **1229/1229** (smoke 39 · adversarial 88 · fix-regression 65 · reconciliation 61 · final-regression 947 · attack-the-fixes 29), fresh install 16/16 migrations / 27 tables from zero, engine independence re-verified. r21/r36 fixture adjustment (seeded-unit 409) — NOT A BUG — VERIFIED. Evidence: `R-45_REVIEW.md`. 46 tags. Previous: v1.43.0 (R-44 F-42-2 starter inventory masters) — release commit `a3f162c478d9e13a2162750b8d6a728d2cdc51f9`, annotated tag `6f1b27631aadac1c50c465b4cc1362fd1b9ef23a` → commit verified via for-each-ref, pushed — `origin/main` = `a3f162c` = `v1.43.0^{}` verified via ls-remote; 45 tags. Release commit `03e4d351e6c1013456bb7c8d1fd25e2f4a193062`, annotated tag `817f60359de6d8665f9e99bb5c6bdfe163042866` → commit verified via for-each-ref, pushed — `origin/main` = `03e4d35` = `v1.42.0^{}` verified via ls-remote; 44 tags. The R-42 P3 operator finding is fixed at the UI layer: `TypeAhead` optional `loading` prop — no create row / Enter→quick-create while the voucher screen's ledger options are on their initial fetch ("Loading options…" hint); R-35 behavior byte-identical after load; cached mounts unaffected. Verified: r43_ui **12/12**, r35 **23/23**, run.js **153/153**, typechecks clean. Working tree at release time contained exactly 7 files (+196/−10 incl. `r43_ui.js`). The starter masters shipped in v1.43.0. Previous: v1.42.0 (R-43 F-42-1 hydration guard) — release commit `03e4d351e6c1013456bb7c8d1fd25e2f4a193062`, annotated tag `817f60359de6d8665f9e99bb5c6bdfe163042866`, pushed; 44 tags. Previous: v1.41.0 (R-42 real-operator drill, docs-only) RELEASED and pushed — commit `801ba49adfb36056f0934d0cb462a0632446b140`, annotated tag `3da7d97db7b4854722ec362101af17144b7a2c56`, `origin/main` = `801ba49` verified via ls-remote; 43 tags. R-42 verdict: **NO P1/P2 DEFECT** — API journey 33/33, browser journey green, operator-grade errors, TB balanced to the paisa. Previous: v1.40.0 (R-41 whole-product re-review) — **PRODUCTION READY** adopted, zero open findings. See CHANGELOG.md, CONTINUE.md.
