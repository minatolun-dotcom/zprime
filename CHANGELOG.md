...
## v1.55.0 — R-64 keyboard correctness (F2 on vouchers, global voucher F-keys) + shortcut display dedup + focus polish (RELEASED 2026-09-25 — commit `b37cc90bf9ee2ce954a556f1d9aac1dbf92fd58c`, annotated tag `33c76ad4756afe7e7818cfa38d8f0b0f27a8f48f`; push pending — operator runs `git push origin main v1.50.0 v1.51.0 v1.52.0 v1.53.0 v1.54.0 v1.55.0` from a credentialed terminal)
